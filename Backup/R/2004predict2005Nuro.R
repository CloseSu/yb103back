...
net.model = neuralnet(avg_price ~ priceWufeng  + trade + air_temp + RH + precp_da + wind_speed_mean + sun + solar_rad + evap + productionDaily ,
                      traindata, hidden=5, threshold=0.01) 
...
table(testdatatarget, results$net.result) 
