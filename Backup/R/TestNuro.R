...
data2013combine2 = data2013combine2[,-2]
data2013combine2[,2:4]=list(NULL)
data2013combine2[,6]=NULL
head(data2013combine2)
...
data2014combine2[,6]=NULL
head(data2014combine2)
str(market_banana2014)

testingdata = subset(data2014combine2[1:300,], select = avg_price ) 
