...
public class index {
	public static void main(String[] args) throws ParseException{	
		...
		String folders = "D:\\document\\R\\count";
		...
		try{						
			...
			text = "create table "+fruit+"("+"period varchar(max)"+","+"count int"+")"+";";
			...
			while((str=in1.readLine())!=null){
				...
				pstmt2.setString(1,inputdata[0]);				
				//pstmt2.setDate(1,new java.sql.Date((sdf.parse(inputdata[0])).getTime()));
